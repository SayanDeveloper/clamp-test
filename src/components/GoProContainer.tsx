...
const GoProContainer = () => {
  return (
    <div className='p-[38px] py-[30px] bg-[#3827b1] rounded-[32px] max-w-[220px]'>
      ...
      <div className='ml-auto w-[100px] bg-black rounded-l-full rounded-br-full cursor-pointer mt-[20px] text-center text-[15px] p-1 py-1.5'>Let's Start</div>
    </div>
  )
}

export default GoProContainer